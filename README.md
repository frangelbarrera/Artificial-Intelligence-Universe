...
- **[Lovable](https://lovable.dev/)**: AI-powered platform that lets you create and deploy apps from a single prompt.
...
- **[CreateLex](https://createlex.com)**: AI-powered plugin for Unreal Engine that lets developers generate Blueprints, C++ code, and node graphs using natural.
...
- **[You.com](https://you.com/)**: A search engine built on AI that provides users with a customized search experience while keeping their data 100%.
...
- **[Lex](https://lex.page/)**: A word processor with artificial intelligence baked in, so you write faster.
...
- **[Headlinesai.pro](https://www.headlinesai.pro/)**: This AI powered tool can help you in generating catchy and optimized headlines based on your content for multiple.
...
### Productivity Tools
- **[Mem](https://mem.ai/)**: Mem is the world's first AI-powered workspace that's personalized to you. Amplify your creativity, automate the.
- **[Taskade](https://www.taskade.com/)**: Build, train, and deploy autonomous AI agents for task management, team collaboration, and workflow automation—all.
...
- **[BrainSoup](https://www.nurgo-software.com/products/brainsoup)**: Multi-agent & multi-LLM native client where AIs can remember, react to events, use tools, leverage local and external.
- **[MindPal](https://mindpal.space/)**: Build your AI Second Brain with a team of AI agents and multi-agent workflow.
- **[fabric](https://github.com/danielmiessler/fabric)**: Apply AI to everyday challenges in the comfort of your terminal. Help's to get better results with tried and tested.
...
- **[Whisper API](https://whisper-api.com)**: Whisper API is a Transcription API Powered By OpenAI Whisper model. Get 5 free transcriptions daily (no duration.
...
- **[Excelmatic](https://excelmatic.ai)**: AI-Powered Excel Data Analysis and Visualization, Skip the functions—just upload, chat, and watch your data turn into.
...
- **[Sybill](https://www.sybill.ai/)**: Sybill generates summaries of sales calls, including next steps, pain points and areas of interest, by combining.
- **[Loopin AI](https://www.loopinhq.com/)**: Loopin is a collaborative meeting workspace that not only enables you to record, transcribe & summaries meetings using.
...
- **[Galactica](https://galactica.org/)**: A large language model for science. Can summarize academic literature, solve math problems, generate Wiki articles,.
...
- **[Portia AI](https://www.portialabs.ai/)**: Open source framework for building agents that pre-express their planned actions, share their progress and can be.
...
- **[Maxim AI](https://www.getmaxim.ai/)**: A generative AI evaluation and observability platform, empowering modern AI teams to ship products with quality,.
...
- **[Amazon Q Developer CLI](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/command-line.html?trk=fd6bb27a-13b0-4286-8269-c7b1cfaa29f0&sc_channel=el)**: CLI that provides command completion, command translation using generative AI to translate intent to commands, and a.
...
- **[TensorZero](https://www.tensorzero.com/)**: An open-source framework for building production-grade LLM applications. It unifies an LLM gateway, observability,.
...
- **[GauGAN2](http://gaugan.org/gaugan2)**: GauGAN2 is a robust tool for creating photorealistic art using a combination of words and drawings since it integrates.
...
- **[Room Reinvented](https://roomreinvented.com)**: Transform your room effortlessly with Room Reinvented! Upload a photo and let AI create over 30 stunning interior.
...
- **[RepublicLabs.AI](https://republiclabs.ai/)**: multi-model simultaneous generation from a single prompt, fully unrestricted and packed with the latest greatest AI.
...
- **[Udio](https://udio.com)**: Musical creation platform with amazing audio quality.
- **[AIVA](https://aiva.ai)**: Soundtrack composer for film, games, and advertising.
- **[LALAL.AI](https://lalal.ai)**: Track separation (vocals, instruments) with surgical precision.
- **[iZotope (AI Suite)](https://izotope.com)**: Professional mastering and audio cleaning tools assisted by AI.

### Voice Cloning & Synthesis
- **[Descript Overdub](https://www.descript.com/overdub)**: Seamlessly integrates with Descript's transcription and editing tools, ideal for content creators needing quick.
...
- **[Audify AI](https://audify-ai.ahmedtokyo.com)**: User-friendly platform for voice synthesis with customizable options and instructions, making it versatile for both.
...
- **[Harmonai](https://www.harmonai.org/)**: We are a community-driven organization releasing open-source generative audio tools to make music production more.
...
- **[Rephrase AI](https://www.rephrase.ai/)**: Rephrase's technology enables hyper-personalized video creation at scale that drive engagement and business.
...
- **[Artflow AI](https://www.app.artflow.ai/)**: Effortlessly turn ideas into Animated Stories & let the Creativity flow.
...
- **[NotFair](https://notfair.co/)**: Hosted Google Ads MCP server connecting Claude and other AI agents to a Google Ads account; diagnose performance,.

### E-commerce & Retail
- **[Klaviyo (AI)](https://klaviyo.com)**: Predictive marketing and sales automation for online stores.
- **[Tidio (Lyro)](https://tidio.com)**: Conversational chatbot that resolves customer questions using your database.
- **[Lindy.ai](https://lindy.ai)**: Autonomous sales agents that manage leads and close meetings.
- **[Flair.ai](https://flair.ai)**: Generation of professional product photography in seconds.

### Human Resources
- **[Juicebox](https://juicebox.ai)**: Talent search and AI-assisted recruitment.
- **[Lattice](https://lattice.com)**: Performance management and organizational culture with predictive insights.
- **[Leapsome](https://leapsome.com)**: Platform for employee development and continuous feedback.
- **[Eightfold AI](https://eightfold.ai)**: Talent intelligence for hiring and retention at scale.

### Journalism & Content
- **[Factinsect](https://factinsect.com)**: Real-time fact-checking for news and articles.
- **[Deepware](https://deepware.ai)**: Specialized scanner for video deepfake detection.
- **[Full Fact](https://fullfact.org)**: Automated tools to combat disinformation.
- **[Logically](https://logically.ai)**: Information integrity analysis and influence campaign detection.

### Healthcare & Wellness
- **[Fitia](https://fitia.app)**: Intelligent meal planning and calorie counting.
- **[EatLove](https://eatlove.is)**: Personalized nutrition based on health goals and preferences.
- **[PlanEat AI](https://planeatai.com)**: Generator of optimized weekly meal plans.
- **[MyFitnessPal AI](https://myfitnesspal.com)**: Food scanning and advanced nutritional analysis.
- **[Woebot Health](https://woebothealth.com)**: Mental health ally based on Cognitive Behavioral Therapy.
...
- **[Claude 3.5/4](https://claude.ai)**: Known for its human tone, large context window, and exceptional programming capabilities.
- **[Gemini 1.5/2.0](https://gemini.google.com)**: Full integration with the Google ecosystem and context window of up to 2 million tokens.
- **[Grok-2/3](https://x.com/i/grok)**: Access to real-time data from X (Twitter) and an uncensored "woke" approach.

### Open Source Models
- **[Llama 3.1/4](https://llama.meta.com)**: The most popular and powerful open model, basis for thousands of derivatives.
- **[DeepSeek-V3/R1](https://deepseek.com)**: Extremely efficient models that compete with GPT-4o at a fraction of the cost.
- **[Mistral / Pixtral](https://mistral.ai)**: European excellence in compact and powerful models for businesses.
...
### Robotics & Hardware
- **[LeRobot (Hugging Face)](https://github.com/huggingface/lerobot)**: Unified framework for training and deploying AI models on physical robots.
- **[NVIDIA Isaac Sim](https://developer.nvidia.com/isaac-sim)**: Photorealistic robotic simulation platform for training AIs in virtual environments.
- **[ROS 2 (Robot Operating System)](https://www.ros.org)**: The industry standard for robotic software development with AI support.
- **[Applied Intuition](https://www.appliedintuition.com)**: Simulation and validation tools for autonomous vehicles and advanced robotics.

### Legal & Governance
- **[Spellbook](https://spellbook.legal)**: AI that helps lawyers draft and review contracts directly in Word.
...
- **[Descartes Labs](https://www.descarteslabs.com)**: Data intelligence platform for processing satellite images at global scale.
- **[Exoplanet AI](https://exoplanets.nasa.gov)**: (NASA Resources) Use of deep learning to identify planets outside the solar system.

### Architecture & 3D
- **[Ark Design AI](https://www.ark.ai)**: Generation of optimized and normative architectural schematic designs.
- **[PromeAI](https://www.promeai.com)**: Transforms hand sketches or simple 3D models into photorealistic renders.
- **[Finch 3D](https://finch3d.com)**: Generative design tool that optimizes floor plans in real-time.
- **[D5 Render](https://www.d5render.com)**: Real-time rendering engine with powerful AI capabilities for architects.

### Sustainability
- **[Green AI Resources](https://github.com/topics/green-ai)**: Repository of tools to reduce the environmental impact of AI training.
- **[Climate Change Data](https://github.com/KKulma/climate-change-data)**: Curation of open data on climate, water, and biodiversity for AI models.
